...
public class PostService {
    ...
    public List<LikeCountResponse> mostLikedUsers() {
        ...
        List<Document> result = mongoClientMap.get("ADMIN").getDatabase(dbname)
                .getCollection("posts").aggregate(pipeline).into(new ArrayList<>());
    ...
    public List<Post> usersLikes(String id) {
        ...
        List<Document> result = mongoClientMap.get("ADMIN").getDatabase(dbname).getCollection("posts")
    ...
    public List<Post> topPosts() {
        ...
        List<Document> result = mongoClientMap.get("GUEST").getDatabase(dbname).getCollection("posts")
                .aggregate(pipeline).into(new ArrayList<>());
